...
public class NetworkFragment extends Fragment{
    ...
    private void initData(){
        ...
        Log.d("test", getArguments().get("rankCategory") + getString(R.string.str_network));
        try {
            jsonObject.put("rankCategory", getArguments().get("rankCategory"));
            jsonObject.put("appCategory", getString(R.string.str_network));
    ...
    private void getData(JSONObject arg0) throws JSONException {
        ...
        /*mAdapter.setOnItemClickListener(new GameAdapter.OnRecyclerViewItemClickListener() {
            @Override
